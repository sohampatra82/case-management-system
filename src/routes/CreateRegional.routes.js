...
const RegionalModel = require("../models/RegionalSignup.model"); // Use consistent name
const { body, validationResult } = require("express-validator");



router.get("/", (req, res) => {
  res.render("CreateRegional");
});
        ...
        return res.send(`
          ...
          <body class="bg-gray-100 flex items-center justify-center min-h-screen">
            <div class="bg-white p-8 rounded-xl shadow-lg max-w-md w-full text-center">
              ...
              <a href="/create-account-regional" class="inline-block px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700">Try Again</a>
            </div>
          </body></html>
        `);
      }
