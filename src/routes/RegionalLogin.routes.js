...
router.post(
  ...
  async (req, res) => {
    try {
        ...
        return res.send(`
                    ...
                    <body class="bg-gray-100 flex items-center justify-center min-h-screen">
                        <div class="bg-white p-8 rounded-xl shadow max-w-md w-full text-center">
                            ...
                            <a href="/regional-login" class="mt-6 inline-block px-6 py-3 bg-blue-600 text-white rounded-xl">Try Again</a>
                        </div>
                    </body></html>
                `);
      }
      ...
      const user = await RegionalModel.findOne({
        $or: [
